...
set JAVA_OPTS=-Xms128m -Xmx%READY_XMX% -Dtest.history.disabled=true -Dsoapui.properties=soapui.properties "-Dsoapui.home=%READY_API_HOME%\"
...
"%JAVA%" %JAVA_OPTS% -cp "%CLASSPATH%" com.smartbear.ready.cmd.runner.pro.SoapUIProSecurityTestRunner %*
