...
set CLASSPATH=%READY_API_HOME%ready-api-ui-2.2.0.jar;%READY_API_HOME%..\lib\*
...
set JAVA_OPTS=-Xms128m -Xmx%READY_XMX% -Dsoapui.properties=soapui.properties -Dgroovy.source.encoding=iso-8859-1 "-Dsoapui.home=%READY_API_HOME%\"
...
"%JAVA%" %JAVA_OPTS% -cp "%CLASSPATH%" com.smartbear.ready.cmd.runner.loaduicommandlinerunner.LoadUIProjectRunner %*
